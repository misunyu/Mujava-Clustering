...
public class BOD_NormalStateWriter extends TraditionalMutantNormalStateWriter {

	public static MutantWriter getMutantCodeWriter(BODChangePointSeeker mutator)
			throws IOException {
		BOD_NormalStateWriter mutantWriter = new BOD_NormalStateWriter(mutator
				.getFileEnvironment());
	...
	public BOD_NormalStateWriter(Environment env) throws IOException {
		super(env, "BOD", true);
