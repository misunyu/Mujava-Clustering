...
public class BOD_NormalWriter extends TraditionalMutantNormalWriter {

	public static MutantWriter getMutantCodeWriter(BODChangePointSeeker mutator)
			throws IOException {
		BOD_NormalWriter mutantWriter = new BOD_NormalWriter(mutator
				.getFileEnvironment());
	...
	public BOD_NormalWriter(Environment env) throws IOException {
		super(env, "BOD", true);
