...
public class BOD_ReachableMutantWriter extends TraditionalReachableMutantWriter {

	public static MutantWriter getMutantCodeWriter(BODChangePointSeeker mutator)
			throws IOException {
		BOD_ReachableMutantWriter mutantWriter = new BOD_ReachableMutantWriter(
	...
	public BOD_ReachableMutantWriter(Environment env) throws IOException {
		super(env, "BOD");
	}
