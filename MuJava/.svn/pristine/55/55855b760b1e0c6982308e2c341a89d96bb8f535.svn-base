...
public class JTI_NormalWriter extends ClassicalMutantNormalWriter {

	public static ClassicalMutantNormalWriter getMutantCodeWriter(JTI mutator)
			throws IOException {
		JTI_NormalWriter mutantWriter = new JTI_NormalWriter(mutator
				.getFileEnvironment());
	...
	public JTI_NormalWriter(Environment env) throws IOException {
		super(env, "JTI", true);
