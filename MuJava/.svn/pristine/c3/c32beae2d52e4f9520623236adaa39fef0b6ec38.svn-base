...
public class ScopeHandlingMutantCodeWriter extends GenericCodeWriter
{
...
//  }
  ...
  public ScopeHandlingMutantCodeWriter( Environment base_env, IMutantInfo mutantFile ) throws IOException
  {
	  super(base_env);
  }
