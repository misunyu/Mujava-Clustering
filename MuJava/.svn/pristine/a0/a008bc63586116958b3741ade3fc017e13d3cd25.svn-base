...
public class LOD_ReachableMutantWriter extends TraditionalReachableMutantWriter {

	public static MutantWriter getMutantCodeWriter(LODChangePointSeeker mutator)
			throws IOException {
		LOD_ReachableMutantWriter mutantWriter = new LOD_ReachableMutantWriter(
	...
	public LOD_ReachableMutantWriter(Environment env) throws IOException {
		super(env, "LOD");
	}
