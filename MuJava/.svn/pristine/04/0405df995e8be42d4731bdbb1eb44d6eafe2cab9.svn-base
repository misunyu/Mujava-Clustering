...
public class EAM_NormalWriter extends ClassicalMutantNormalWriter {
	private Map<ChangePoint, List<String>> alternativeMethods = null;

	@SuppressWarnings("unchecked")
	public static ClassicalMutantNormalWriter getMutantCodeWriter(EAM mutator)
			throws IOException {
		EAM_NormalWriter mutantWriter = new EAM_NormalWriter(mutator
				.getFileEnvironment());
	...
	public EAM_NormalWriter(Environment env) throws IOException {
		super(env, "EAM", false);
	}
