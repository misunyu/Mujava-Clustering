...
public class PRV_NormalWriter extends ClassicalMutantNormalWriter {

	private Map<ChangePoint, List<String>> variableTable;

	public static ClassicalMutantNormalWriter getMutantCodeWriter(PRV mutator)
			throws IOException {
		PRV_NormalWriter mutantWriter = new PRV_NormalWriter(mutator
				.getFileEnvironment());
	...
	public PRV_NormalWriter(Environment env) throws IOException {
		super(env, "PRV", false);
	}
