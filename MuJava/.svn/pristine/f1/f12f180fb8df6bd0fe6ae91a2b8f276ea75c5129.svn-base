...
public class LOI_NormalWriter extends TraditionalMutantNormalWriter {

	public static MutantWriter getMutantCodeWriter(LOIChangePointSeeker mutator)
			throws IOException {
		LOI_NormalWriter mutantWriter = new LOI_NormalWriter(mutator
				.getFileEnvironment());
	...
	public LOI_NormalWriter(Environment env) throws IOException {
		super(env, "LOI", true);
