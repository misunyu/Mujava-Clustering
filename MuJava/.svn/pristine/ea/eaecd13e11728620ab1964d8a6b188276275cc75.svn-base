...
public class LOR_ReachableMutantWriter extends TraditionalReachableMutantWriter {
	public static TraditionalReachableMutantWriter getMutantCodeWriter(
			LORChangePointSeeker mutator) throws IOException {
		LOR_ReachableMutantWriter mutantWriter = new LOR_ReachableMutantWriter(
	...
	public LOR_ReachableMutantWriter(Environment env) throws IOException {
		super(env, "LOR");
	}
