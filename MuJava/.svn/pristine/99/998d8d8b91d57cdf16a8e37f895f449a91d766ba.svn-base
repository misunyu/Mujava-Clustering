...
public class AOIS_NormalWriter extends TraditionalMutantNormalWriter {

	public static MutantWriter getMutantCodeWriter(AOISChangePointSeeker mutator)
			throws IOException {
		AOIS_NormalWriter mutantWriter = new AOIS_NormalWriter(mutator
				.getFileEnvironment());
	...
	public AOIS_NormalWriter(Environment env) throws IOException {
