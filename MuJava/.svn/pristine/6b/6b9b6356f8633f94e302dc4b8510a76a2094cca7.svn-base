...
public class AODS_NormalStateWriter extends TraditionalMutantNormalStateWriter {

	public static MutantWriter getMutantCodeWriter(AODSChangePointSeeker mutator)
			throws IOException {
		AODS_NormalStateWriter mutantWriter = new AODS_NormalStateWriter(mutator
				.getFileEnvironment());
	...
	public AODS_NormalStateWriter(Environment env) throws IOException {
		super(env, "AODS", true);
