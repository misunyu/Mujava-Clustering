...
public class PNC_NormalWriter extends ClassicalMutantNormalWriter {

	private Map<ChangePoint, List<String>> variableTable;

	public static ClassicalMutantNormalWriter getMutantCodeWriter(PNC mutator)
			throws IOException {
		PNC_NormalWriter mutantWriter = new PNC_NormalWriter(mutator
				.getFileEnvironment());
	...
	public PNC_NormalWriter(Environment env) throws IOException {
		super(env, "PNC", false);
	}
