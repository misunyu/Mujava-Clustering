...
public class EOC_NormalWriter extends ClassicalMutantNormalWriter {

	public static ClassicalMutantNormalWriter getMutantCodeWriter(EOC mutator)
			throws IOException {
		EOC_NormalWriter mutantWriter = new EOC_NormalWriter(mutator
				.getFileEnvironment());
	...
	public EOC_NormalWriter(Environment env) throws IOException {
		super(env, "EOC", true);
