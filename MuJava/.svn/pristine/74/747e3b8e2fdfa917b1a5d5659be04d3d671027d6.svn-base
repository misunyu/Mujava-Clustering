...
public class BOI_NormalWriter extends TraditionalMutantNormalWriter {

	public static MutantWriter getMutantCodeWriter(BOIChangePointSeeker mutator)
			throws IOException {
		BOI_NormalWriter mutantWriter = new BOI_NormalWriter(mutator
				.getFileEnvironment());
	...
	public BOI_NormalWriter(Environment env) throws IOException {
		super(env, "BOI", true);
