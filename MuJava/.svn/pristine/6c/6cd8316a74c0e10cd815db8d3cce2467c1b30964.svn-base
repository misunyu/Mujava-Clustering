...
public class ISK_NormalWriter extends ClassicalMutantNormalWriter {

	public ISK_NormalWriter(Environment env) throws IOException {
		super(env, "ISK", true);
	...
	public static ClassicalMutantNormalWriter getMutantCodeWriter(ISK mutator)
			throws IOException {
		ISK_NormalWriter mutantWriter = new ISK_NormalWriter(mutator
				.getFileEnvironment());
