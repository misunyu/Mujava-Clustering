...
public class LORChangePointSeeker extends AbstractChangePointSeeker {
	public LORChangePointSeeker(ICompilationUnit sourceJavaElement, FileEnvironment file_env) {
		super(file_env, sourceJavaElement, "LOR");
	}
