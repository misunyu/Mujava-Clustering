...
public class LOI_NormalStateWriter extends TraditionalMutantNormalStateWriter {

	public static MutantWriter getMutantCodeWriter(LOIChangePointSeeker mutator)
			throws IOException {
		LOI_NormalStateWriter mutantWriter = new LOI_NormalStateWriter(mutator
				.getFileEnvironment());
	...
	public LOI_NormalStateWriter(Environment env) throws IOException {
		super(env, "LOI", true);
