...
public class EOA_NormalStateWriter extends ClassicalMutantNormalStateWriter {

	public static ClassicalMutantNormalStateWriter getMutantCodeWriter(EOA mutator)
			throws IOException {
		EOA_NormalStateWriter mutantWriter = new EOA_NormalStateWriter(mutator
				.getFileEnvironment());
	...
	public EOA_NormalStateWriter(Environment env) throws IOException {
		super(env, "EOA", true);
