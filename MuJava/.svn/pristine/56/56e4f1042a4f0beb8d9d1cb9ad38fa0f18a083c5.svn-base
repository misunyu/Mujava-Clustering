...
public class JTD_NormalWriter extends ClassicalMutantNormalWriter {

	public static ClassicalMutantNormalWriter getMutantCodeWriter(JTD mutator)
			throws IOException {
		JTD_NormalWriter mutantWriter = new JTD_NormalWriter(mutator
				.getFileEnvironment());
	...
	public JTD_NormalWriter(Environment env) throws IOException {
		super(env, "JTD", true);
