...
public class AOIU_NormalWriter extends TraditionalMutantNormalWriter {

	public static MutantWriter getMutantCodeWriter(AOIUChangePointSeeker mutator)
			throws IOException {
		AOIU_NormalWriter mutantWriter = new AOIU_NormalWriter(mutator
				.getFileEnvironment());
	...
	public AOIU_NormalWriter(Environment env) throws IOException {
		super(env, "AOIU", true);
