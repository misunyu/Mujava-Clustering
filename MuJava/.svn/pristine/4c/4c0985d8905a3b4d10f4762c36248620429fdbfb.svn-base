...
public class JSI_NormalStateWriter extends ClassicalMutantNormalStateWriter {

	boolean isMutantTarget = false;

	public JSI_NormalStateWriter(Environment env) throws IOException {
		super(env, "JSI", true);
	...
	public static ClassicalMutantNormalStateWriter getMutantCodeWriter(JSI mutator)
			throws IOException {
		JSI_NormalStateWriter mutantWriter = new JSI_NormalStateWriter(mutator
				.getFileEnvironment());
