...
public class EMM_NormalStateWriter extends ClassicalMutantNormalStateWriter {
	private Map<ChangePoint, List<String>> methodTable = null;

	@SuppressWarnings("unchecked")
	public static ClassicalMutantNormalStateWriter getMutantCodeWriter(EMM mutator)
			throws IOException {
		EMM_NormalStateWriter mutantWriter = new EMM_NormalStateWriter(mutator
				.getFileEnvironment());
	...
	public EMM_NormalStateWriter(Environment env) throws IOException {
		super(env, "EMM", false);
	}
