...
public class AMC_NormalStateWriter extends ClassicalMutantNormalStateWriter {

	public static ClassicalMutantNormalStateWriter getMutantCodeWriter(AMC mutator)
			throws IOException {
		AMC_NormalStateWriter mutantWriter = new AMC_NormalStateWriter(mutator
				.getFileEnvironment());
	...
	public AMC_NormalStateWriter(Environment env) throws IOException {
		super(env, "AMC", true);
