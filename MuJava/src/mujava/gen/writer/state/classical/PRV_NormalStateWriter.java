...
public class PRV_NormalStateWriter extends ClassicalMutantNormalStateWriter {

	private Map<ChangePoint, List<String>> variableTable;

	public static ClassicalMutantNormalStateWriter getMutantCodeWriter(PRV mutator)
			throws IOException {
		PRV_NormalStateWriter mutantWriter = new PRV_NormalStateWriter(mutator
				.getFileEnvironment());
	...
	public PRV_NormalStateWriter(Environment env) throws IOException {
		super(env, "PRV", false);
	}
