...
public class EAM_NormalStateWriter extends ClassicalMutantNormalStateWriter {
	private Map<ChangePoint, List<String>> alternativeMethods = null;

	@SuppressWarnings("unchecked")
	public static ClassicalMutantNormalStateWriter getMutantCodeWriter(EAM mutator)
			throws IOException {
		EAM_NormalStateWriter mutantWriter = new EAM_NormalStateWriter(mutator
				.getFileEnvironment());
	...
	private void setAlternativeMethodTable(
		...
		this.alternativeMethods = methodTable;
	}

	public EAM_NormalStateWriter(Environment env) throws IOException {
		super(env, "EAM", false);
	}
	...
	public void visit(MethodCall p) throws ParseTreeException {
		...
		if (super.currentChangePoint != null
			...
			String log_str = p.toFlattenString() + " => " + getEAMCode(index);
	...
	private String getEAMCode(int index) {
		List<String> vars = this.alternativeMethods.get(currentChangePoint);
		assert (vars != null);
