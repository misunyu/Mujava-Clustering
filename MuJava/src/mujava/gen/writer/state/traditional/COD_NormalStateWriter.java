...
public class COD_NormalStateWriter extends TraditionalMutantNormalStateWriter {

	public static MutantWriter getMutantCodeWriter(CODChangePointSeeker mutator)
			throws IOException {
		COD_NormalStateWriter mutantWriter = new COD_NormalStateWriter(mutator
				.getFileEnvironment());
	...
	public COD_NormalStateWriter(Environment env) throws IOException {
		super(env, "COD", true);
