...
public class LOD_NormalStateWriter extends TraditionalMutantNormalStateWriter {

	public static MutantWriter getMutantCodeWriter(LODChangePointSeeker mutator)
			throws IOException {
		LOD_NormalStateWriter mutantWriter = new LOD_NormalStateWriter(mutator
				.getFileEnvironment());
	...
	public LOD_NormalStateWriter(Environment env) throws IOException {
		super(env, "LOD", true);
