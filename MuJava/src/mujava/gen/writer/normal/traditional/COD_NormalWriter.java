...
public class COD_NormalWriter extends TraditionalMutantNormalWriter {

	public static MutantWriter getMutantCodeWriter(CODChangePointSeeker mutator)
			throws IOException {
		COD_NormalWriter mutantWriter = new COD_NormalWriter(mutator
				.getFileEnvironment());
	...
	public COD_NormalWriter(Environment env) throws IOException {
		super(env, "COD", true);
