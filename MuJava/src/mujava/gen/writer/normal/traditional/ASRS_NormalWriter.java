...
public class ASRS_NormalWriter extends TraditionalMutantNormalWriter {
	public static TraditionalMutantNormalWriter getMutantCodeWriter(
			ASRSChangePointSeeker mutator) throws IOException {
		ASRS_NormalWriter mutantWriter = new ASRS_NormalWriter(mutator
				.getFileEnvironment());
	...
	public ASRS_NormalWriter(Environment env) throws IOException {
	...
	public void visit(AssignmentExpression p) throws ParseTreeException {
		...
		if (super.currentChangePoint.isSamePoint(p, currentMethod)) {
			...
			out.print(" " + getASRSCode(newOperator) + " ");
