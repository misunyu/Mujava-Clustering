...
public class AODU_NormalWriter extends TraditionalMutantNormalWriter {

	public static MutantWriter getMutantCodeWriter(AODUChangePointSeeker mutator)
			throws IOException {
		AODU_NormalWriter mutantWriter = new AODU_NormalWriter(mutator
				.getFileEnvironment());
	...
	public AODU_NormalWriter(Environment env) throws IOException {
		super(env, "AODU", true);
