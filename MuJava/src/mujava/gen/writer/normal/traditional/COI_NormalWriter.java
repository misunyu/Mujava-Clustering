...
public class COI_NormalWriter extends TraditionalMutantNormalWriter {

	public static MutantWriter getMutantCodeWriter(COIChangePointSeeker mutator)
			throws IOException {
		COI_NormalWriter mutantWriter = new COI_NormalWriter(mutator
				.getFileEnvironment());
	...
	public COI_NormalWriter(Environment env) throws IOException {
		super(env, "COI", true);
