...
public class LOR_NormalWriter extends TraditionalMutantNormalWriter {
	public static TraditionalMutantNormalWriter getMutantCodeWriter(
			LORChangePointSeeker mutator) throws IOException {
		LOR_NormalWriter mutantWriter = new LOR_NormalWriter(mutator
				.getFileEnvironment());
	...
	public LOR_NormalWriter(Environment env) throws IOException {
		super(env, "LOR", true);
...
/*			if(newOperator ==0 ){
	...
	*/		
			...
			out.print(" " + getLORCode(newOperator) + " ");
