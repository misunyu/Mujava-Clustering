...
public class COI_ReachableMutantWriter extends TraditionalReachableMutantWriter {

	public static MutantWriter getMutantCodeWriter(COIChangePointSeeker mutator)
			throws IOException {
		COI_ReachableMutantWriter mutantWriter = new COI_ReachableMutantWriter(
	...
	public COI_ReachableMutantWriter(Environment env) throws IOException {
		super(env, "COI");
	}
