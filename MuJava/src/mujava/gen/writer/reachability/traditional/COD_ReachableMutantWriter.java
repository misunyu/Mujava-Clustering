...
public class COD_ReachableMutantWriter extends TraditionalReachableMutantWriter {

	public static MutantWriter getMutantCodeWriter(CODChangePointSeeker mutator)
			throws IOException {
		COD_ReachableMutantWriter mutantWriter = new COD_ReachableMutantWriter(
	...
	public COD_ReachableMutantWriter(Environment env) throws IOException {
		super(env, "COD");
	}
