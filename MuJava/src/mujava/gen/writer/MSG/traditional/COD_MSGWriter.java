...
public class COD_MSGWriter extends TraditionalMutantMSGWriter {
	public static MutantWriter getMutantCodeWriter(CODChangePointSeeker mutator)
			throws IOException {
		COD_MSGWriter mutantWriter = new COD_MSGWriter(mutator
				.getFileEnvironment());
	...
	public COD_MSGWriter(Environment env) throws IOException {
		super(env, "COD");
