...
public class COI_MSGWriter extends TraditionalMutantMSGWriter {
	public static MutantWriter getMutantCodeWriter(COIChangePointSeeker mutator)
			throws IOException {
		COI_MSGWriter mutantWriter = new COI_MSGWriter(mutator
				.getFileEnvironment());
	...
	public COI_MSGWriter(Environment env) throws IOException {
		super(env, "COI");
	}
