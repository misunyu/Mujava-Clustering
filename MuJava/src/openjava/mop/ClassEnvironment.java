...
public class ClassEnvironment extends ClosedEnvironment {
	...
	public OJClass lookupClass(String name) {
		/*
		 * should hold and return member classes Currently, the global
		 * environment holds all the top inner classes.
		 */
	...
	/*
	 * private String parentName() { Environment ancestor = parent; while
	 * (ancestor != null && ! (ancestor instanceof ClassEnvironment)) { ancestor =
	 * ancestor.parent; } if (ancestor == null) return null; return
	 * ancestor.currentClassName(); }
	 */
	 ...
	 * 
	 * @return the qualified name of the class which organizes this environment.
	 */
	public String currentClassName() {
		return toQualifiedName(getClassName());
	}

	// Modified by swkim, similar to lookupBind()
